...
from .views import delete_job,AddNewJobsPage
urlpatterns = [
    ...
    path('searchfortasks.html/', views.SearchForTasksPage, name='search_for_tasks'),
    ...
    path('get_available_job_ids/', views.get_available_job_ids, name='get_available_job_ids'),
